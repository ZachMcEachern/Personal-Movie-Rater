...
public class TaskListDB {
    ...
    private static class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            // insert lists
            db.execSQL("INSERT INTO list VALUES (1, 'Highest Rated')");
            db.execSQL("INSERT INTO list VALUES (2, 'Recent')");
            
            // insert sample tasks
            db.execSQL("INSERT INTO task VALUES (1, 1, 'Shrek 2', " +
                    "'5', '12/10/2017', '0')");
            db.execSQL("INSERT INTO task VALUES (2, 1, 'Santa Claus', " +
                    "'4.5', '12/09/2017', '0')");
        }
    ...
    public long insertTask(Task task) {
        ...
        cv.put(TASK_NAME, task.getNameOfMovie());
        cv.put(TASK_NOTES, task.getStringRating());
        cv.put(TASK_COMPLETED, task.getDateSeen());
